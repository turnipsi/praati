...
tested on OpenBSD 5.5 with its own Apache version (a fork of 1.3).
It is probably possible to port it to other systems or Apache
versions with only little work.
...
welcome.  This software is in public domain, meaning that the author
disclaims copyright to the source code.
